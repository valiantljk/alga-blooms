...
if(_2c){
_28.find("input.combobox-text").attr("name",_2c);
...
_29.bind('change',function(){
	
	//$(_29).trigger('focus'); //鼠标粘贴事件处理

});
_29.attr("autocomplete","off").focus(function(){
_53(_27,"");
}).keyup(function(e){
	$(_27).prev(".auto_id").val(''); //默认清空
	$(_27).prev(".auto_id").trigger('change'); //
...
_59.addClass("combobox-item-selected");	
	$(_54).prev('.auto_id').val($(_59).attr('value')); //auto change
	$(_54).prev(".auto_id").trigger('change'); //
}
}else{
_59.hide();
}
...
$.fn.combobox.defaults={width:"auto",listWidth:null,listHeight:null,valueField:"value",textField:"text",editable:true,url:null,onLoadSuccess:function(){
	...
	$(this).prev(".auto_id").val($(this).combobox('getValue')); //autocomplete改变事件
	$(this).prev(".auto_id").trigger('change'); //
