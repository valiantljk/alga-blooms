...
$(document).ready(function(){
	...
	$("[id='error_span']").each(function(){		
		...
		$(this).html('');		
		$(this).css({"line-height":"100%", "width":"120px","z_index":"100","position":"absolute","left":new_left+"px","top":new_top+"px" });
		var error_html = '<div><div style="width:100%;height:14px;"><img src="/ci_app/images/error_msg_top.gif"></div>';
			 error_html += '<div  style="width:100%;float:left;font-size:12px;	color:red;	padding:5px;	border:1px solid #FF7C06;background:#FDFCEB;	z-index:9999;"><div style="float:left">'+inner_html+'</div>';
