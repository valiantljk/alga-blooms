...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var OTHEparameter=new Array('Sample Depth(03)','Temperature(10)','Conductance(95)','Dissolved Oxygen(300)',
            ...
            var OTHEcode=new Array('00003','00010','00095','00300','00400','00480','00665','00900',
        ...
        <?php
        $title = "Texas Reservoir Water Quality Database";
    ...
    <div id="container">
        ...
        echo form_open('basicquery/quality_result', $attributes);
        ?>

            <table border="1" align="center" >
                <tr>
                    <!--'parameter','date from','date to','source','reservoir'-->
                    <th ><? echo $sour ?></th>
                    <th ><? echo $para ?></th>
                    <th ><? echo $rese ?></th>
                </tr>
                <tr>
                    <td align="center"><!--source-->
                        <select name='source' onChange="ChangeSource(form.source.selectedIndex);">
                            <option value=""></option>
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        <input type="text" name="ldepth" size="3">
                        
                        <input type="text" name="hdepth" size="3">

                        <select name='unit' id="language">
