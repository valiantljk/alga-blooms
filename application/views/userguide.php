    ...
    <body> 
        ...
        <div id="container">
			...
			<div id="sideBar">
				...
				<li><a href="../../index.php/basicquery/select">Processing/Analysis</a></li>
				</ul>
			</div>
            <div id="content">
            	<?php

        echo "this page will be about how to use this database";
        ?>
            </div>
            <div id="footer">
<script language="javascript" type="text/javascript" src="js/dates.js"></script>
<p>
<a href="mailto:jialin.ttu.edu">Contact the webmaster</a><br />
